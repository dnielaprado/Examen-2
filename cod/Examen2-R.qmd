...
# Renombrar categorías y eliminar identificador
df_arbol <- moras %>%
  mutate(
...
# Construir árbol
arbol <- rpart(INDICADOR_MOROSO ~ ., data = df_arbol, method = "class")

# Graficar árbol
rpart.plot(arbol, type = 2, extra = 104, fallen.leaves = TRUE, faclen = 8)
```
